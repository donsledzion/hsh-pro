...
public class ArmchairFurnitureController : MonoBehaviour
{
    ...
    private void FetchFurniture()
    {
        ...
        furnitureAsset = AssetBundle.LoadFromFile("AssetBundles/StandaloneWindows/furniture_bundle_armchairs");
